...
static xdata uint8_t gzp_system_address[GZP_SYSTEM_ADDRESS_WIDTH];
static xdata uint8_t gzp_host_id[GZP_HOST_ID_LENGTH];
...
*/
static xdata bool gzp_id_req_pending;
